...
const App = () => {
  console.log(`[Kanji Hunt] v${__APP_VERSION__} loaded`);
      ...
      {activeSection === 'capture' && (
        firebaseUser
          ...
          : <div style={{ minHeight: '100vh', background: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', paddingBottom: '100px' }}>
              ...
              <p style={{ fontSize: '15px', color: '#5f6368', margin: '0 0 40px 0', textAlign: 'center', lineHeight: '1.4' }}>The best app to learn Japanese phrases</p>
